  ...
  return (
    <div className='planPage immigration'>
      ...
      <div className='container'>
            ...
            <div className='col-12'>
              <div className='content'>
                <p>
                  ...
                  My Immigration Hub. We are dedicated to providing comprehensive legal
                ...
                <p>
                  At My Immigration Hub, our attorneys possess a deep understanding of
                ...
                <p>
                  At My Immigration Hub, we are steadfast in our dedication to supporting
        ...
        {pathname === "/plan/immigration/uandtvisas" ? (
          <Link className='chooseBtn' href={"/payment/uandt"}>
