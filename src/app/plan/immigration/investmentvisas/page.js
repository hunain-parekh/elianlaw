...
const InvestmentVisas = ({ setShowPayment }) => {
  ...
  return (
    <div className='planPage immigration'>
      ...
      <div className='container'>
          ...
          <div className='row'>
            <div className='col-12'>
              <div className='content'>
                <p>
                  Embrace a world of business opportunities and unlock your
                  investment potential in the United States. At My Immigration Hub, we
                  specialize in investment visas, offering comprehensive legal
                  services to individuals and businesses aiming to capitalize on
                  the vibrant U.S. market.
                </p>
                <p>
                  Navigating the intricate landscape of investment visas demands
                  profound knowledge and a keen understanding of immigration
                  laws and regulations. Our experienced team of attorneys
                  remains at the forefront, constantly updated with the latest
                  developments and policies, to provide you with cutting-edge
                  advice and guidance.
                </p>
                <p>
                  We cater to individuals and visionary entrepreneurs from
                  around the world, helping them secure the appropriate
                  investment visa tailored to their specific needs. Discover
                  some of the prominent investment visa categories we handle
                  with finesse:
                </p>
                <p>
                  EB-5 Immigrant Investor Visa: The prestigious EB-5 program
                  allows foreign investors to obtain lawful permanent residency
                  in the United States by making a qualifying investment and
                  creating a specific number of jobs. From selecting suitable
                  investment opportunities to filing the necessary petitions and
                  navigating rigorous requirements, we guide you through the
                  entire EB-5 process.
                </p>
                <p>
                  E-2 Treaty Investor Visa: Investors from select treaty
                  countries can seize the advantages of the E-2 visa, enabling
                  them to establish or manage a business in the United States.
                  Our expert guidance will help you understand the eligibility
                  criteria, prepare the necessary documentation, and
                  strategically approach your E-2 visa application.
                </p>
                <p>
                  L-1 Visa for Investors: If you already have a thriving
                  business abroad and seek to expand operations to the United
                  States, the L-1 visa is your gateway. This visa category
                  empowers multinational companies to transfer executives,
                  managers, and specialized knowledge employees to their U.S.
                  branches or subsidiaries.
                </p>
                <p>
                  Our dedicated team works closely with you to grasp your
                  investment goals and develop a personalized strategy that
                  maximizes your chances of success. From meticulously preparing
                  your petition and supporting documents to ensuring compliance
                  with all requirements, we guide you through the intricate
                  process with unwavering precision.
                </p>
                <p>
                  At My Immigration Hub, we recognize the significance of your investment
                  aspirations and the transformative impact they can have on
                  your future. That's why we strive to deliver exceptional
                  service, expert advice, and diligent representation, providing
                  you with the utmost confidence to navigate the complexities of
                  investment visas.
                </p>
                <p>
                  Whether you are an individual investor or represent a business
                  seeking lucrative investment opportunities in the United
                  States, we stand ready to guide you every step of the way.
                  Contact us today to schedule a consultation with one of our
                  experienced attorneys, and embark on the journey to realizing
                  your investment dreams in the United States. Your future
                  awaits!
                </p>
              </div>
            </div>
        ...
        {pathname === "/plan/immigration/investmentvisas" ? (
          <Link className='chooseBtn' href={"/payment/investment"}>
            Choose a Plan for Investment
          </Link>
        ) : (
